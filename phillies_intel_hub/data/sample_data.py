# Sample data module for Phillies Analytics
...
WinProbData = pd.DataFrame({
    'game_id': ['GID_2026_05_23_phimia_1'] * 9,
    'inning': [1, 2, 3, 4, 5, 6, 7, 8, 9],
    'top': [True, True, True, True, True, False, False, False, False],
    'out': [0, 0, 0, 0, 0, 0, 0, 0, 0],
    'home_score': [0, 1, 2, 3, 5, 5, 5, 5, 5],
    'away_score': [0, 0, 0, 0, 0, 2, 2, 2, 2],
    'win_prob': [0.50, 0.52, 0.55, 0.60, 0.62, 0.62, 0.62, 0.62, 0.62]
})
